...
const MenuData = ({
  ...
  const { menuData, isLoading, total } = usePengeluaran(search, limit, page);
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-neutral-100 dark:bg-neutral-800">
                ...
                <TableHead className="py-5">Nama Pengeluaran</TableHead>
              ...
              {isLoading ? (
                ...
                menuData.map((menu, index) => (
                  ...
                  >
                    ...
                    <TableCell className="py-3">Rp.{menu.amount}</TableCell>
                    <TableCell className="py-3">
