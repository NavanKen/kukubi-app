...
const ProductDetailPublic = ({ productId }: ProductDetailProps) => {
  ...
  const fetchProduct = useCallback(async () => {
    ...
    if (!error && data) setProduct(data as IProduk);
    setIsLoading(false);
  }, [productId]);
        ...
        <div className="grid md:grid-cols-2 gap-8 p-6">
          ...
          <div className="flex flex-col">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 rounded-xl font-semibold text-lg hover:from-orange-600 hover:to-red-600 transition-all flex items-center justify-center gap-3"
            >
        ...
        {!userId ? (
          ...
          <div className="mb-8 p-4 bg-gray-50 rounded-xl">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 resize-none mb-4"
              rows={4}
            />
